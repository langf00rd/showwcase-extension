...
export const useStore = create((set) => ({
  ...
  setShowAccountMenu: (showAccountMenu) =>
    set(() => ({ showAccountMenu: showAccountMenu })),
  showAPIKeyInputModal: false,
  setShowAPIKeyInputModal: (showAPIKeyInputModal) =>
    set(() => ({ showAPIKeyInputModal: showAPIKeyInputModal })),
  trendingShows: [],
  setTrendingShows: (trendingShows) => set(() => ({ trendingShows: trendingShows })),
  recommendedShows: [],
  setRecommendedShows: (recommendedShows) =>
    set(() => ({ recommendedShows: recommendedShows })),
  activeTab: TABS[0],
